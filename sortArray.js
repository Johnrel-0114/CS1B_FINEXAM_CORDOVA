// Step 1: Get numbers from the user and convert to number array
...
// Step 2: Get names from the user and create an array
...
// Step 3: Merge numbers and names into one array
let mergedArray = numbers.concat(names);
console.log("Merged Array:", mergedArray);

// Step 4: Sort numbers in descending order and log
let sortedNumbers = numbers.sort((a, b) => b - a);
console.log("Sorted Numbers (Reverse):", sortedNumbers);

// Step 5: Sort names alphabetically and log
